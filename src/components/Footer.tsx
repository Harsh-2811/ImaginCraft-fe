...
const Footer = () => {
  return <footer className='bg-[#00477A] text-[#E8EAED]'>
        ...
        <div className="py-[100px] text-center md:text-left">
          <div className="gap-3 grid grid-cols-1 sm:grid-cols-4 md:grid-cols-12 lg:grid-cols-12">
            <div className="col-span-1 sm:col-span-4 md:col-span-4 lg:grid-cols-4">
              ...
              <p className="pt-5">
                Lorem Ipsum is simply dummy text printing addon typesetting into industry.
              </p>
              ...
              <div className="mt-4 flex items-center">
                <div className="h-[44px] w-[44px] border rounded-full p-1 flex items-center justify-center">
                  <a className=""><img className="h-[20px] w-[20px]" src={facebookIcon} /></a>
                </div>
                <div className="h-[44px] w-[44px] border rounded-full p-1 flex items-center justify-center ms-3">
                  <a className=""><img className="h-[20px] w-[20px]" src={instagramIcon} /></a>
                </div>
            ...
            <div className="col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-2">
              <h6
                className="mb-4 flex justify-center font-semibold text-[18px] uppercase md:justify-start text-white">
                Snelle links
              </h6>
              <p className="mb-3">
                <a href="/">Home</a>
            ...
            <div className="col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-2">
              <h6
                className="mb-4 flex justify-center font-semibold uppercase md:justify-start text-white text-[18px]">
                Belangrijke links
              </h6>
              <p className="mb-3">
            ...
            <div className="col-span-1 sm:col-span-4 md:col-span-4 lg:col-span-4">
              ...
              <div className="flex items-center w-full">
                <input type="text" className="bg-[#00477A] w-full border-b-[1px] h-[33px] pb-[10px] focus:border-0 focus:border-b-[1px] outline-none" placeholder="Email" />
                <button className="bg-[#0081A8] p-2">
                  <img src={sendNewsletterIcon} alt="icon" />
                </button>
              </div>
              <p className="pt-3">Inclusief updates en speciale promoties via e-mail.</p>
            </div>
          </div>
        </div>
      </div>

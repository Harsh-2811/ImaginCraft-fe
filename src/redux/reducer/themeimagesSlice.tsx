...
export const fetchThemeImages = createAsyncThunk('fetchThemeImages', async (category_id) => {
    debugger
  ...
  const response = await axios.get(`${VITE_API_URL}/assets/themes/${category_id}/`, config);

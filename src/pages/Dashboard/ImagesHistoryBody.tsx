      ...
      <div className="m-5">
        <div className="grid gap-5 md:grid-cols-2 grid-cols-1 mb-5">
          <div className="relative">
            <input
              className="border border-[#ADADAD] w-full rounded-[4px] py-2 px-4"
              type="text"
              placeholder="Search.."
            />
        ...
        <div className="grid md:grid-cols-2 gap-5 grid-cols-1">
          <div className="border border-[#ADADAD] rounded-lg flex flex-wrap p-4">
            ...
            <div className="sm:w-[55%] w-full pl-4">
              <h4
                className="text-20pxFont font-bold pb-3 mt-2 sm:mt-0"
              ...
              <div className="mb-2">
                <div className="py-1">
                  ...
                  <span className="text-14pxFont font-semibold">
                    {' '}
                    10 May 2024
                  </span>
                </div>

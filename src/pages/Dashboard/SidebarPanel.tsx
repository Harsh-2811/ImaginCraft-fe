      ...
      <div className="bg-blue-600 w-full h-full rounded-xl">
        ...
        <div className="mt-5 px-5">
          <ul className="text-white">
            <li
              className={`flex px-4 py-[0.6rem] items-center rounded-lg cursor-pointer ${pathname.includes('dashboard') ? 'bg-orange-400' : ''}`}
            ...
            >
              ...
              >
                <g clip-path="url(#clip0_775_768)">
                  <path
                    d="M5.85547 1.67189H3.61589L0 6.4284L3.61589 11.1849H5.85547L2.23958 6.4284L5.85547 1.67189ZM10.1445 1.67189H12.3841L16 6.4284L12.3841 11.1849H10.1445L13.7604 6.4284L10.1445 1.67189ZM9.13672 0.00522185L9.91276 0.186211C10.0352 0.214857 10.1107 0.337253 10.0833 0.459649L7.15365 13.0495C7.125 13.1706 7.0026 13.2474 6.88021 13.2201L6.10547 13.0391C5.98307 13.0104 5.90755 12.888 5.9349 12.7656L8.86458 0.175795C8.89323 0.054701 9.01562 -0.0221219 9.13672 0.00522185Z"
                    fill="white"
                  />
                </g>
                <defs>
            ...
            <li
              className={`flex px-4 py-[0.6rem] items-center rounded-lg cursor-pointer ${pathname.includes('imageshistory') ? 'bg-orange-400' : ''} `}
            ...
            <li
              className={`flex px-4 py-[0.6rem] items-center rounded-lg cursor-pointer ${pathname.includes('profile') ? 'bg-orange-400' : ''}`}
            ...
            >
              ...
              >
                <g clip-path="url(#clip0_775_707)">
                  <path
                    d="M8 9.11304C9.21242 9.11304 10.3752 8.63298 11.2325 7.77847C12.0898 6.92396 12.5714 5.76499 12.5714 4.55652C12.5714 3.34806 12.0898 2.18909 11.2325 1.33457C10.3752 0.480061 9.21242 0 8 0C6.78758 0 5.62482 0.480061 4.76751 1.33457C3.9102 2.18909 3.42857 3.34806 3.42857 4.55652C3.42857 5.76499 3.9102 6.92396 4.76751 7.77847C5.62482 8.63298 6.78758 9.11304 8 9.11304ZM6.36786 10.8217C2.85 10.8217 0 13.6624 0 17.1688C0 17.7526 0.475 18.2261 1.06071 18.2261H14.9393C15.525 18.2261 16 17.7526 16 17.1688C16 13.6624 13.15 10.8217 9.63214 10.8217H6.36786Z"
                    fill="white"
                  />
                </g>
                <defs>
            ...
            <li
              className={`flex px-4 py-[0.6rem] items-center rounded-lg cursor-pointer ${pathname.includes('billing-details') ? 'bg-orange-400' : ''} `}

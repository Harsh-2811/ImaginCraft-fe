...
export const SignIn = () => {
  ...
  const [emailbordervalidationcolor, setEmailBorderValidationColor] = useState("#e5e7eb")
  const [passbordervalidationcolor, setPassBorderValidationColor] = useState("#e5e7eb")
            ...
            <div className="mt-2 p-8">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  required
                />
                <p style={{color : emailbordervalidationcolor}} >{emailvalidation}</p>
              </div>
              <div className="flex mt-4 flex-col relative">
                ...
                <input
                  ...
                  required
                />
                <p style={{color : passbordervalidationcolor}} >{passvalidation}</p>

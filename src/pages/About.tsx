    ...
    return (
        <>
                ...
                <div className='grid md:grid-cols-2'>
                    <div className="mt-[30px] md:mt-0 ps-[20px] md:ps-0">
                        <h2 className="text-[34px] font-bold max-w-[476px]">
                            We are making <br></br> the <span className="text-[#F16E22] ">Digital Future</span>
                        </h2>
                    ...
                    <div className='md:relative md:mt-0 mt-10'>
                        ...
                        <div className='px-5 py-3 bottom-10 md:absolute bg-[#0081A8] text-white'>
                            <h5 className='text-[45px] leading-[45px] font-extrabold'>10K+</h5>
            ...
            <div className='text-center'>
                ...
                <div className='mt-3'>
                    <h3 className='text-[40px] text-[#2F2F2F] font-bold leading-[50px]'>Here is some example of our
                        <br></br>
                        <span className='text-[#F16E22]'>AI Generated Images</span></h3>
                </div>

                <div className='flex items-end flex-wrap mt-[50px]'>
                    <div className='flex-1'>
                        <div className='h-[360px] mb-4'>
                            <img src={bgAuthImage} className='rounded-[16px] object-cover h-full w-full' />
                        </div>
            ...
            <div className="max-w-[1220px] px-[20px] mx-auto text-[#2F2F2F] mt-14">
                <div className="my-5">
                    <div className="text-center">
                        ...
                        <h1 className="text-[40px] font-semibold mt-4">AI Benefits Will Impress You</h1>
                    </div>
                    ...
                    <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-10 mt-[80px]'>
                        <div className="group cursor-pointer rounded-xl border border-[#00AEB8] min-h-[200px] bg-white flex flex-col items-center  hover:bg-[#00AEB8] transition">
                            <div className=" -m-[1px] rounded-full top flex justify-center items-center"><img src={fortIcon} alt="profile image" className='h-[64px] w-[64px] mb-[49px]' /></div>
                            <div className='text-center p-3'>
                                <h3 className='group-hover:text-white text-[22px] font-bold text-[#0B2529]'>Excellent support</h3>
                                <p className='group-hover:text-white mt-2 text-[16px]  text-[#565656]'>Lorem Ipsum is simply dummy text of the printing and typesetting  industry. Lorem Ipsum has been the industry's standard dummy text  ever since the 1500s.</p>
                            </div>
                        </div>
                        <div className="group cursor-pointer rounded-xl border border-[#00AEB8] min-h-[200px] bg-white flex flex-col items-center  hover:bg-[#00AEB8] transition">
                            <div className=" -m-[1px] rounded-full top flex justify-center items-center"><img src={relaibleIcon} alt="profile image" className='h-[64px] w-[64px] mb-[49px]' /></div>
                            <div className='text-center p-3'>
                                <h3 className='group-hover:text-white text-[22px] font-bold text-[#0B2529]'>Reliable experts</h3>
                                <p className='group-hover:text-white mt-2 text-[16px]  text-[#565656]'>Lorem Ipsum is simply dummy text of the printing and typesetting  industry. Lorem Ipsum has been the industry's standard dummy text  ever since the 1500s.</p>
                            </div>
                        </div>
                        <div className="group cursor-pointer rounded-xl border border-[#00AEB8] min-h-[200px] bg-white flex flex-col items-center  hover:bg-[#00AEB8] transition">
                            <div className=" -m-[1px] rounded-full top flex justify-center items-center"><img src={possibalitiesIcon} alt="profile image" className='h-[64px] w-[64px] mb-[49px]' /></div>
                            <div className='text-center p-3'>
                                <h3 className='group-hover:text-white text-[22px] font-bold text-[#0B2529]'>Endless possibilities</h3>
                                <p className='group-hover:text-white mt-2 text-[16px]  text-[#565656]'>Lorem Ipsum is simply dummy text of the printing and typesetting  industry. Lorem Ipsum has been the industry's standard dummy text  ever since the 1500s.</p>
                            </div>
                        </div>
                        <div className="group cursor-pointer rounded-xl border border-[#00AEB8] min-h-[200px] bg-white flex flex-col items-center  hover:bg-[#00AEB8] transition">
                            <div className=" -m-[1px] rounded-full top flex justify-center items-center"><img src={technologyIcon} alt="profile image" className='h-[64px] w-[64px] mb-[49px]' /></div>
                            <div className='text-center p-3'>
                                <h3 className='group-hover:text-white text-[22px] font-bold text-[#0B2529]'>Unique technology</h3>
                                <p className='group-hover:text-white mt-2 text-[16px]  text-[#565656]'>Lorem Ipsum is simply dummy text of the printing and typesetting  industry. Lorem Ipsum has been the industry's standard dummy text  ever since the 1500s.</p>
                            </div>
                        </div>
                        ...
                        <div className="md:w-1/2 w-full">
                            <div className='grid sm:grid-cols-12 sm:grid-rows-8 gap-5'>
                                ...
                                <div className='col-span-4 row-span-4'>
                                    <img className='rounded-[8px]' src="https://s3-alpha-sig.figma.com/img/776f/da1c/fb5b145ed7f3edd720edd3ff25f0ff6d?Expires=1714348800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=NHkfZZIQLvgCLbhMIUZxh2k4xBiytS97zrJXhYW1kgMznO8hF8MkLm-UC57tMoREwEnT-LTJhfJRWsFxScDC4RMZA7yp9tpzAPqyQQI3IrbtnKos6HIjhQ8E1aoUTL4js2CN6d75PBqWrCZqM0Xo20nV-IEqxp1n5OHFrIHtfuRtwo7O3PLaAdKMmZGqyGgL0YcHBtF6QE0rkN0z5ZFl2as9CRw-Zf9ckAfjEJOVBsejKaexkU6zunvqordZno46Y~aml9Urdy8YLD-ScYh4LSC9bM6AfLAbNwPyFDh4lEMQ5DcIcFvc2OwrUHkA4fh~VQyqoVAfbR7obFNOA4FZ1w__" />
                                </div>
